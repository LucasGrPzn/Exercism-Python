...
def tag_special_ingredients(dish: tuple) -> tuple:
    ...
    dish_special_ingredients = ingredients & SPECIAL_INGREDIENTS

    return name, dish_special_ingredients
...
def singleton_ingredients(dishes: list, intersection) -> set:
    ...
    singleton = set()
    for dish in dishes:
        singleton = singleton.union(dish - intersection)
